...
################################################################
# This is a generated script based on design: u96_dpu
#
...
proc create_root_design { parentCell } {
  ...
  set dpu_eu [ create_bd_cell -type ip -vlnv xilinx.com:ip:dpu_eu:3.0 dpu_eu ]
  set_property -dict [ list \
   CONFIG.ARCH {2304} \
