...
proc create_root_design { parentCell } {
  ...
  set mezz_int_0 [ create_bd_port -dir I -from 0 -to 0 mezz_int_0 ]
  set mezz_int_1 [ create_bd_port -dir I -from 0 -to 0 mezz_int_1 ]
  set mezz_uart_0_rxd [ create_bd_port -dir I -type data mezz_uart_0_rxd ]
  set mezz_uart_0_txd [ create_bd_port -dir O -type data mezz_uart_0_txd ]
  set mezz_uart_1_rxd [ create_bd_port -dir I -type data mezz_uart_1_rxd ]
  set mezz_uart_1_txd [ create_bd_port -dir O -type data mezz_uart_1_txd ]
  ...
  connect_bd_net -net In2_0_1 [get_bd_ports mezz_int_0] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net In3_0_1 [get_bd_ports mezz_int_1] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_uart16550_0_ip2intc_irpt [get_bd_pins axi_uart16550_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports mezz_uart_0_txd] [get_bd_pins axi_uart16550_0/sout]
  connect_bd_net -net axi_uart16550_1_ip2intc_irpt [get_bd_pins axi_uart16550_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports mezz_uart_1_txd] [get_bd_pins axi_uart16550_1/sout]
  connect_bd_net -net emio_uart0_ctsn_0_1 [get_bd_ports BT_ctsn] [get_bd_pins zynq_ultra_ps_e_0/emio_uart0_ctsn]
  connect_bd_net -net mezz_uart_0_rxd_1 [get_bd_ports mezz_uart_0_rxd] [get_bd_pins axi_uart16550_0/sin]
  connect_bd_net -net mezz_uart_1_rxd_1 [get_bd_ports mezz_uart_1_rxd] [get_bd_pins axi_uart16550_1/sin]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins axi_uart16550_1/s_axi_aresetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_99M/peripheral_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_0/S_AXI/Reg] SEG_axi_uart16550_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
